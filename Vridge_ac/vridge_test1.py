...
anglesposition = Struct(
    "Version" / Const(3, Int32ul),  # Version
    "TaskType" / Const(3, Int32ul),  # SendRadRotationAndPosition
...
justposition = Struct(
    "Version" / Const(3, Int32ul),  # Version
    "TaskType" / Const(5, Int32ul),  # SendPosition
    Const(24, Int32ul),  # DataLength
...
print(output)
print(justposition.parse(output))
